...
import com.iti.presentation.components.ProductItem
...
fun AllProductsScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(if (activeBrand != null) "$activeBrand Products" else "Featured Products", fontWeight = FontWeight.Bold) },
                navigationIcon = {
